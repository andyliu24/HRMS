    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
                        ...
                        <div class="panel-body">
                            <form role="form" id="change_name" class="form-inline" name="change_name" method="post" action="setting">
                                <div class="form-group">
                                    <label for="new_name">新名字：&nbsp;</label><input type="text" class="form-control" name="new_name" />
                                </div>&nbsp;&nbsp;
                    ...
                    <div id="panel-element-422222" class="panel-collapse in">
                        <div class="panel-body">
                            <form role="form" id="change_password" class="form-inline" name="change_password" method="post" action="setting">
                                <div class="form-group">
                                    <label for="old_password">原密码：&nbsp;</label><input type="password" class="form-control" name="old_password" />
                                </div>&nbsp;&nbsp;&nbsp;&nbsp;
                                <div class="form-group">
                                    <label for="new_password">新密码：&nbsp;</label><input type="password" class="form-control" name="new_password" />
                                </div>&nbsp;&nbsp;
            ...
            <script>
                ...
                var username = document.getElementById("show_alert_username");
                var password = document.getElementById("show_alert_username");
