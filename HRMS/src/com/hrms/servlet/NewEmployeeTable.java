...
//@WebServlet(name = "NewEmployeeTable")
public class NewEmployeeTable extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(start_date==null || end_date==null){
            ...
            request.getRequestDispatcher("report_new_employee.jsp").forward(request,response);
        }
        ...
        List<Employee> result = employeeDao.findRegisterEmployee(start,end);
