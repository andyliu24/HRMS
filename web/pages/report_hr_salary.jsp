		...
		option = {
		    ...
		    series : [
		        ...
		        },
		        {
		            ...
		            data:[
		                { value:<%=request.getAttribute("count1")%>, name:'0~5000'},
						{ value:<%=request.getAttribute("count2")%>,name:'5000~10000'},
						{ value:<%=request.getAttribute("count3")%>, name:'10000~20000'},
						{ value:<%=request.getAttribute("count4")%>, name:'20000+'},
		            ]
		        }
		    ]
		};
